...
<div class="row">
	...
	<div class="col-md-2">
			<input  type="text" id="email" name="mail" data-toggle="tooltip" data-placement="top" title="Email"  style="position: absolute;margin-top:-30px;" required><label id="unerror"></label>
			<input type="checkbox"><a href="#"  >Keep Me logged in</a>
	</div>
	<div class="col-md-2">
			<input type="password"  id="pwd"  name="pwd" data-toggle="tooltip" data-placement="top" title="Password" style="position: absolute;margin-top:-30px;" required><label id="pserror"></label>
